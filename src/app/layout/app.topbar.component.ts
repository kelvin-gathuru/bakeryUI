        ...
        this.tieredItems = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Stocking', icon: 'pi pi-fw pi-plus', routerLink: ['/dashboard/consumables/stocking'] },
                    { label: 'Requisition', icon: 'pi pi-fw pi-question', routerLink: ['/dashboard/consumables/requisition'] },
                    { label: 'Dispatch', icon: 'pi pi-fw pi-arrow-right', routerLink: ['/dashboard/consumables/dispatch'] },
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Product Stock', icon: 'pi pi-fw pi-list', routerLink: ['/dashboard/production/product-stock'] },
                    { label: 'Product Dispatch', icon: 'pi pi-fw pi-arrow-right', routerLink: ['/dashboard/production/product-dispatch'] },
                    { label: 'Dispatch Sales Report', icon: 'pi pi-fw pi-file-excel', routerLink: ['/dashboard/production/dispatch-report'] }, 
                    { label: 'Ingredients Vs Sales', icon: 'pi pi-fw pi-money-bill', routerLink: ['/dashboard/production/ingredients-vs-sales'] },                ]
            },
            {
                label: 'Sales Reports',
